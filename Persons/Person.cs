...
namespace Family2Person.Persons
{
    ...
    public abstract partial class Person : ModelElement, IPerson, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(Family2Person.Persons.Person.ClassInstance)).Resolve("name")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Family2Person.Persons.Person.ClassInstance)).Resolve("birthday")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Family2Person.Persons.Person.ClassInstance)).Resolve("personsInverse")));
        }
